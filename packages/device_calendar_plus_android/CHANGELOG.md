...
- Added support for reading and writing attendees
- Added `createOrEditEventModal()` implementation using native calendar Intent
- Updated `createEvent()` and `updateEvent()` to handle `attendees`
